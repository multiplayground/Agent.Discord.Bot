...
async def my_background_task(client):
    ...
    channel_to_send = client.get_channel(571991415450099972) # 568791671764942868 -noisy tests 571991415350099972 - automaton
    channels_str=None
        ...
        if channel_tipes != channel_tipes_1 :
            ...
            with RpcClient(aHostName='157.230.108.47',aQueueName='Task.Discord.Tree') as rpcClient:
                ...
                if resp == 'None':
                    ...
                    await str_img.send_img(client.get_channel(571991415450099972),'serv_sturct.1.png')
                else:
                    ...
                    fh.close()
                    await str_img.del_img()
                    await str_img.send_img(client.get_channel(571991415450099972),'serv_sturct.png')
